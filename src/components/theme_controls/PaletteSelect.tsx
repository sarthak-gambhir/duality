...
export function PaletteSelect({ 'aria-label': ariaLabel = 'Palette', className }: PaletteSelectProps) {
  const { theme, setTheme } = useTheme();
  const options = paletteNames.map((name) => ({ value: name, label: palettes[name].label }));
