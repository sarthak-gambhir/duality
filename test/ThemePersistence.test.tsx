...
describe("ThemeProvider persistence", () => {
  ...
  it("writes theme and density to localStorage", async () => {
  ...
  it("restores from localStorage on init", () => {
    window.localStorage.setItem(
      "du_test",
      JSON.stringify({ theme: "phosphor", density: "compact" }),
    );
    render(
      <ThemeProvider storageKey="du_test">
        <Probe />
    ...
    expect(screen.getByTestId("state")).toHaveTextContent("phosphor:compact");
  });
});
