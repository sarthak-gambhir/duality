...
import { DataTable, type DataTableColumn } from '../src/components/data_table/DataTable';
...
const columns: DataTableColumn<Row>[] = [
  { id: 'name', header: 'Name', cell: (r) => r.name, value: (r) => r.name, sortable: true },
  { id: 'score', header: 'Score', cell: (r) => r.score, value: (r) => r.score, sortable: true },
];
...
describe('DataTable', () => {
  ...
  it('shows an empty message when nothing matches', async () => {
    const user = userEvent.setup();
    renderTable();
    await user.type(screen.getByRole('textbox', { name: 'Filter Scores' }), 'zzz');
